...
namespace HORIZON::RENDERAPI
{
	...
	public:
		...
		/*!
		 * @brief The API function loader. Requires a function name or identifier and returns the corresponding function
		 * pointer.
		 */
	...
	public:
		 ...
		 * @param loader The api function loader provided by the window library. If no loader is available, nullptr is a
		 * valid parameter as well.
